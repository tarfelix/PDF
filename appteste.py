...
• CORREÇÃO: Lógica de exibição de abas corrigida para funcionar corretamente.
"""
...
# ------------- Abas Dinâmicas (LÓGICA CORRIGIDA) --------------------
tabs_to_show = []
if is_single_pdf_mode:
    # Se for um único arquivo, monte a lista de abas de edição
...
# A aba "Mesclar" está sempre disponível
...
with tab_map["Mesclar"]:
    ...
    elif is_single_pdf_mode and len(files_to_merge) <= 1: st.warning("Você carregou apenas um arquivo. Para mesclar, carregue múltiplos arquivos.")
    else:
